...
public class MyArtListAdapter extends RecyclerView.Adapter<MyArtListAdapter.ViewHolder> {
    ...
    public MyArtListAdapter(Context context, List<Art> artList, OnItemClickListener listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_my_art_list, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.txtRatingUser.setText("Ratingmu: " +
                (art.rata2RatingUser > 0 ?
                        String.format("%.1f", art.rata2RatingUser) : "N/A"));
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView txtTitle, txtCategory, txtPublished,
                txtReviewers, txtChapters, txtRating, txtRatingUser;
